...
//          this.previousRightTime = this.endDate.clone();
            ...
            this.updateView();
            this.container.find('.ranges:eq(0)').hide();
            this.container.show();
            this.move();
...
//      	//console.log('我是第23个方法');
            ...
            $('#get_stime').val(this.container.find('input[name="daterangepicker_start"]').val())
            $('#get_etime').val(this.container.find('input[name="daterangepicker_end"]').val())
            // $('#seltime_form').submit()
            this.hide();
